...
env = environ.Env(
    ...
    API_MOCK_PUBLIC_ACCESS_ENABLED=(bool, False),
    API_MOCK_MAX_DELAY_MS=(int, 5000),
    API_MOCK_RATE_LIMIT_PER_MINUTE=(int, 120),
...
API_MOCK_PUBLIC_ACCESS_ENABLED = env("API_MOCK_PUBLIC_ACCESS_ENABLED")
API_MOCK_MAX_DELAY_MS = env("API_MOCK_MAX_DELAY_MS")
API_MOCK_RATE_LIMIT_PER_MINUTE = env("API_MOCK_RATE_LIMIT_PER_MINUTE")
