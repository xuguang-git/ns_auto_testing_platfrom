...
export const platformApi = {
  ...
  environmentHealth: (id: number, params?: Record<string, unknown>) => http.get(`/environments/${id}/health/`, { params, cache: false }),
  runEnvironmentHealth: (id: number, payload?: Record<string, unknown>) => http.post(`/environments/${id}/health/run/`, payload || {}, { timeout: 45000, cache: false }),
